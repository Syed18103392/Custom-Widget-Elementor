...
?>
    ...
    {
    ?>
        <# var image_target=settings.image_link.is_external ? ' target="_blank"' : '' ; var image_nofollow=settings.image_link.nofollow ? ' rel="nofollow"' : '' ; var link_target=settings.button_link.is_external ? ' target="_blank"' : '' ; var link_nofollow=settings.button_link.nofollow ? ' rel="nofollow"' : '' ; view.addInlineEditingAttributes( 'card_title' , 'none' ); view.addInlineEditingAttributes( 'item_description' , 'none' ); #>
            <div class="image-card">
                <div class="image-wrapper">
